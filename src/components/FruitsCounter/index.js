            ...
            <div className="counter-control">
              ...
              <div className="button-container">
                <button
                  type="button"
                  className="button"
                  // FIX7: The event handler should be passed as a refrence to the onClick attribute
            ...
            <div className="counter-control">
              ...
              <div className="button-container">
                <button
                  type="button"
                  className="button"
                  // FIX8: The event handler should be passed as a refrence to the onClick attribute
